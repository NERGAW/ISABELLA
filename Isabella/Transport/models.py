...
class NodeConnection:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {"connection_id": self.connection_id, "node_id": self.node_id, "connected_at": self.connected_at, "last_seen": self.last_seen, "remote_address": self.remote_address, "protocol_version": self.protocol_version, "status": self.status.value, "authenticated": self.authenticated, "messages_received": self.messages_received, "messages_sent": self.messages_sent, "errors": self.errors}
